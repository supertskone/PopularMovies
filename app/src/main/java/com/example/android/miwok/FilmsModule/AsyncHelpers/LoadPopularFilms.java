...
public class LoadPopularFilms extends AsyncTask<String, Void, ArrayList<MovieDb>> {

    public LoadPopularFilms(Listener listener) {
        mListener = listener;
    }
    ...
    protected ArrayList<MovieDb> doInBackground(String... strings) {
        ...
        MovieResultsPage moviez = movies.getPopularMovies("en", 1);
